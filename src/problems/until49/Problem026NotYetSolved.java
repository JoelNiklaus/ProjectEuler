...
public class Problem026NotYetSolved {
	...
	private static int searchForRecurringCycle(String searchString, Stack<Character> stack, int numberOfOccurrences) {
	...
	private static BigDecimal unitFraction(int denominator) {
		return BigDecimal.ONE.divide(new BigDecimal("" + denominator), precision, RoundingMode.HALF_UP);
	}
}
